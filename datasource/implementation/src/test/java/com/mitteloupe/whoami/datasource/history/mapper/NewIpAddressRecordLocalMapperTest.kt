...
class NewIpAddressRecordLocalMapperTest(
    ...
    private lateinit var classUnderTest: NewIpAddressRecordLocalMapper
    ...
    @Before
    fun setUp() {
        classUnderTest = NewIpAddressRecordLocalMapper(nowProvider)
    }
