...
class SavedIpAddressRecordDomainMapperTest(
    ...
    private lateinit var classUnderTest: SavedIpAddressRecordDomainMapper

    @Before
    fun setUp() {
        classUnderTest = SavedIpAddressRecordDomainMapper()
    }
